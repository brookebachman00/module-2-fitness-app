...
recipe1 = Recipe.create(name:"Leek Soup", diet: diet6, img:'/atkin/leek_soup.jpg', url: "https://www.atkins.com/recipes/asparagus-and-leek-soup/786/" )

recipe2 = Recipe.create(name:"Apricot Glazed Brisket", diet: diet6, img:'/atkin/beef_brisket.jpg', url: "https://www.atkins.com/recipes/apricot-glazed-brisket/617" )

recipe3 = Recipe.create(name:"Asian Baked Salmon", diet: diet6, img:'/atkin/baked_salmon.jpg', url: "https://www.atkins.com/recipes/asian-baked-salmon-with-bok-choy/2475/" )

recipe4 = Recipe.create(name:"Macho Chili", diet: diet6, img:'/atkin/chili.jpg', url: "https://www.atkins.com/recipes/ancho-macho-chili/738/" )

recipe5 = Recipe.create(name:"Asian Beef Salad", diet: diet6, img:'/atkin/beef_salad.jpg', url: "https://www.atkins.com/recipes/asian-beef-salad-single-serving/2029/")
...
recipe15 = Recipe.create(name:"Mediterranean Potato Salad",  diet: diet2, img:'/mediterranean/med_salad.jpg', url: "https://www.bbcgoodfood.com/recipes/mediterranean-potato-salad-0/")
